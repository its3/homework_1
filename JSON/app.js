...
*/
function renderContactWithTemplate(contact){
    var container = document.querySelector('.contact-template');

    contact.map(createContactFromTemplate).forEach(function(contactHTML){
        container.innerHTML += contactHTML;
    });
}

//renderContactWithTemplate( contact );

getJSON( 'exampleData.json' , renderContactWithTemplate );